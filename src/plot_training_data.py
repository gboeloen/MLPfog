...
lplot3, = ax1.plot(ldate,lwind,color='g', linestyle='solid', linewidth=2.0, label='wind speed')
...
# save fig
plt.savefig("training_data.png",format="png", bbox_inches='tight')
...
lgrid1 = ax1.grid(color='grey', linestyle='-.', linewidth=0.2)
# save fig
plt.savefig("training_data_demo.png",format="png", bbox_inches='tight')
...
# save fig
plt.savefig("training_dist.png",format="png", bbox_inches='tight')
